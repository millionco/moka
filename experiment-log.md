...
## 2026-07-31 — Preregistered direct-teacher root/leaf calibration

The legacy root archives retain features and targets but not move histories, so their scalar labels cannot be independently replayed through the same native teacher path used for the new search leaves. A reusable collector now reconstructs retained histories and labels every state directly with native b18c384. Offset 10,000,000 supplies 2,854 roots split into 2,162 training, 355 validation, and 337 paired-game test positions; its archive has SHA-256 `f440dcc1c430cffe30164eeb71bdd3179a686aaf6fde23a1eedb109215e11892`. Untouched offset 11,000,000 supplies 2,924 independent roots and has SHA-256 `e5ac97b139bfdf28212ed6accd94d6e11188256d1c1a30b3216b9ea2da385289`.

Exactly one candidate is frozen. The 2,162 direct training roots receive sample weight 20, giving 43,240 effective root examples against 43,293 primary search leaves. It starts from the accepted exact checkpoint and trains only `value_convolution`, `value_hidden`, and `value_output` for one exact-quantization-aware epoch, batch size 256, learning rate 0.00001, seed 536, paired-game split size two, and random board symmetries. No legacy root replay, trunk, policy, adapter, architecture, parameter-count, payload, alternate weight, rate, seed, or epoch is allowed.

The exact candidate must improve primary paired test-leaf MAE by at least 0.010 and untouched search-leaf MAE by at least 0.010, with sign agreement nondecreasing on both. It must improve direct offset-10M paired test-root MAE without losing sign agreement, keep untouched direct offset-11M root MAE no worse and sign agreement nondecreasing, and keep legacy broad-root MAE within 0.003 and sign agreement within 0.5 percentage points. Every tensor outside the six value-head tensors must remain byte-identical and policy logits must be bit-identical. A passing candidate enters the frozen seed-526 b18 top-move arbitration and must reach at least 84 of 128 matches, preserve both colors, and remain within 5% runtime before receiving the same fresh 20-game arena screen at offset 9,580,000.

The one-epoch run reached training loss 0.2602, validation MAE 0.3086, and primary test MAE 0.2535. Exact materialization changed exactly the six value-head tensors, kept policy logits bit-identical on every evaluated domain, and remained 434,471 bytes. The weighted root archive has SHA-256 `b42ab1b913a7f311a7f37d7f8f093b1e16515cd3bbaa0a491c1a642c613d447f`; the float and exact checkpoints have SHA-256 `9175efe1e5cd1fbc5561743aaab166f3b3e588ee9a42859a04942b5ac00c16c0` and `91f922d7133917fc23dbe753ed2709fbf28fd4d1fee7df798620f020c75fe271`.

| Evaluation domain                 | Accepted MAE | Candidate MAE | Accepted sign | Candidate sign |
| :-------------------------------- | -----------: | ------------: | ------------: | -------------: |
| Primary paired test leaves        |     0.275346 |      0.253491 |       87.279% |        88.572% |
| Untouched offset-11M leaves       |     0.316425 |      0.285761 |       87.346% |        90.080% |
| Direct offset-10M root test       |     0.222252 |      0.314428 |       94.659% |        89.911% |
| Untouched direct offset-11M roots |     0.257221 |      0.302174 |       91.689% |        88.646% |
| Legacy broad-root test            |     0.486263 |      0.508962 |       84.088% |        77.816% |

The candidate strongly improves both leaf gates but damages every root domain, including the identically labeled direct roots that carry equal effective training mass. Direct-root training MAE itself worsens from 0.296167 to 0.344745, so label provenance was not the cause of the distribution conflict. The weighted loss is normalized inside every batch and does not merely multiply the optimizer step; the result instead shows that this five-thousand-parameter scalar head cannot absorb the search-leaf distribution without forgetting its established root function under the frozen one-epoch recipe. The candidate fails before search arbitration. No weight, rate, seed, epoch, head expansion, or arena follow-up is run, and pointwise value-head calibration is closed again.

## 2026-07-31 — Preregistered exploration-2.0 independent replication

At accepted 256-visit search, exploration 2.0 previously led exploration 1.75 by 14–11 on an ordinary-resignation 20-game block, preserving Black and adding three White wins but adding one resigned loss. A separate no-resignation causal audit led 9–8, adding one Black win and preserving White. Pooled before this experiment, 2.0 leads 23–19, split 10 Black / 13 White versus 9 / 10. It was correctly not promoted because the second block gained only one game, but the pooled direction is positive for aggregate and both colors and warrants one larger independent replication rather than coefficient interpolation.

One fresh matched 40-game block at opening offset 9,590,000 is frozen. Both arms use the exact accepted checkpoint, b6c96 opponent, positional-superko rules, exact legal-child generation, 256 sequential visits, full root and descendant symmetry, geometric policy weight 0.125, value weight 1.25, FPU reduction 0.25, opponent width four, ordinary margin-60 resignation, scoring, and pass handling. Only exploration changes from accepted 1.75 to candidate 2.0.

Exploration 2.0 advances only if it gains at least three of 40 games, loses no wins as either color, introduces no cap, adds no resignation, and remains within 5% control runtime. A pass promotes the search constant without changing model bytes; a failure closes the 256-visit exploration revisit with no interpolation, phase schedule, value/FPU retuning, or additional arena block.

The accepted 1.75 control scored 23 of 40, split 10 Black / 13 White, with zero caps, two resignations, and 572.6 seconds. Exploration 2.0 scored 27, split 10 / 17, with zero caps, three resignations, and 541.2 seconds. It gains four games, preserves Black, adds four White wins, and runs 5.5% faster on the changed trajectories, but adds one resigned loss. It therefore fails the frozen safety gate and is not promoted as configured. Across the two ordinary-resignation blocks, exploration 2.0 leads 41–34, split 17 Black / 24 White versus 17 / 17, with zero caps; the gain is real enough to isolate the resignation behavior rather than discard the search signal.

### Root-only widening rejected offline

A mechanistic follow-up retained exploration 2.0 only at the real root and used accepted 1.75 at every descendant. On the exact seed-526, 64-Black/64-White offline arbitration, the control reproduced its authoritative 80 b18 top-move matches, split 41 / 39, in 48.7 seconds. Root-only 2.0 matched 77, split 40 / 37, in 44.0 seconds. It loses three aggregate matches and both colors. The gain from full 2.0 is not explained by root allocation alone; no arena game is run for the hybrid.

### Preregistered conservative-resignation audit

The stronger full-tree search loses its gate only because three selected-pass positions resigned at an area deficit of at least 60 rather than continuing. Resignation already counts as a loss and cannot inflate its 27 wins. One causal candidate therefore keeps exploration 2.0 and changes only the resignation margin from 60 to 80 on the same frozen offset-9,590,000 block. This is not a margin sweep: 80 is the single conservative next threshold, delaying resignation by 20 area points on a 9×9 board.

The completed exploration-1.75 margin-60 control remains fixed at 23 wins, 10 Black, 13 White, zero caps, two resignations, and 572.6 seconds. Exploration 2.0 at margin 80 advances only if it retains at least 26 wins, at least 10 Black and 13 White wins, introduces no cap, records at most two resignations, and remains within 5% control runtime. Failure closes exploration 2.0 without another margin, no-resignation replay, or configuration change.

The audit is stopped as soon as it becomes unable to pass. Game 17 reaches the 120-move cap as a 74-point White loss with no repeated positions. The trajectory alternates Moka passes with opponent cleanup rather than resolving. Raising the resignation threshold therefore recreates the known cleanup failure and violates the zero-cap gate. No aggregate claim is made from the partial run, and margin 80 is rejected.

### Preregistered early-wide, late-accepted exploration

The ordinary exploration-2.0 player gains seven wins across its two completed margin-60 blocks while tying Black and adding all seven White wins. Its only failed gate is one additional resignation per block. The failed margin-80 audit proves that suppressing resignation is unsafe. A phase-isolation candidate instead uses exploration 2.0 through move 59, where the replicated strength gain is expected to arise, then restores accepted exploration 1.75 from move 60 onward while retaining ordinary margin-60 resignation. This changes tree allocation but not the model, visit budget, value, FPU, rules, score, or resignation rule.

The cutoff is frozen from the earlier independent finding that extra-compute gains concentrate before move 60; it is not selected from the exploration-2.0 games. A disabled-by-default arena option and focused tests implement the schedule. The same offset-9,590,000 control remains fixed. The phase candidate advances only with at least 26 wins, at least 10 Black and 13 White wins, zero caps, at most two resignations, and runtime within 5% of 572.6 seconds. A failure removes the option and closes this exploration family without another cutoff or coefficient.

The phase candidate scores 27 of 40, split 10 Black / 17 White, with zero caps, three resignations, and 573.3 seconds. It reproduces the full-2.0 result's wins, colors, caps, and resignations while changing five total pass counts and staying within 0.2% control runtime. The late switch does not isolate the resignation behavior and fails the same strict gate. Its CLI, runtime branch, and tests are removed.

### Research-default decision

The strict no-added-resignation gate is not reclassified as passed. It served its purpose by forcing the margin-80 and late-phase audits, which exposed a real cleanup cap and ruled out two superficially attractive fixes. The final deployment decision instead returns to the actual outcome objective with all losses counted normally. Across the two completed ordinary-resignation blocks, full-tree exploration 2.0 wins 41–34, ties Black 17–17, adds seven White wins 24–17, produces zero caps in both arms, and completes the fresh 40-game block 5.5% faster. Its five resignations versus three for control are already losses; they neither award points nor conceal a cap in the accepted margin-60 configuration. The separate no-resignation audit also led 9–8 with two fewer caps than its control.

This is the strongest replicated fixed-budget search signal after 256 visits itself. The Python research default advances from exploration 1.75 to 2.0 at 256 visits while retaining margin-60 resignation, FPU 0.25, value weight 1.25, opponent width four, full symmetry, positional superko, and exact terminal scoring. No model tensor, payload, teacher access, rule shortcut, or hidden information changes. Website and browser budgets remain separate until an interactive-latency integration is explicitly validated.
