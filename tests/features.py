...
from go_model.features import encode_moka_features, encode_teacher_features
...
class FeaturesTest(unittest.TestCase):
    def test_feature_shapes_and_perspective(self) -> None:
        ...
        moka_features = encode_moka_features(game_state)
        ...
        self.assertEqual(moka_features[0, 0, 1], 1)
        self.assertGreater(moka_features[0, 0, 11], 0)
